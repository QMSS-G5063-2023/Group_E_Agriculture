...
ui <- fluidPage(
  ...
  navbarPage("🍉 🥝 U.S. Fruit & Veggies Exploration 🍒 🌽",
             ...
             tabPanel("Home", fluid = TRUE,
                      ...
                      p("Our data sources are"),
                      a('the National Agriculture Statistics Service', href = 'https://www.nass.usda.gov/'),
                      p("and "),
                      p(a('the Food and Agriculture Organization of the United Nations', href = 'https://www.fao.org/faostat/en/#data/TM')),
                      ),
...
server <- function(input, output, session) {
  ###################### U.S. RIDGEPLOT FOR MONTHLY PRICES ####################
  # Create standard ridgeline plot
